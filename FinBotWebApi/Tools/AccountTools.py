...
GET_USER_ACCOUNTS_TOOL = {
    ...
    "description": "Kullan�c�n�n FinTrack sistemindeki t�m finansal hesaplar�n� (�rne�in banka hesaplar�, c�zdanlar) ve mevcut bakiyelerini listeler.",
    "parameters": {
        "type": "OBJECT",
        "properties": {},
        "required": []
...
GET_ACCOUNT_DETAILS_TOOL = {
    ...
    "description": "Kullan�c�n�n belirli bir finansal hesab�n�n detaylar�n� (ID ile) ve bakiyesini getirir.",
    "parameters": {
        "type": "OBJECT",
        "properties": {
            "account_id": {
                "type": "INTEGER",
                "description": "Detaylar� g�r�nt�lenecek hesab�n ID'si."
            }
        },
        "required": ["account_id"]
    }
...
CREATE_ACCOUNT_TOOL = {
    "name": "create_account",
    "description": "Kullan�c� i�in yeni bir finansal hesap (�rne�in banka hesab�, nakit c�zdan�) olu�turur.",
    "parameters": {
        "type": "OBJECT",
        "properties": {
            "name": {"type": "STRING", "description": "Olu�turulacak hesab�n ad� (�rne�in 'Maa� Hesab�m', 'Nakit C�zdan�')."},
            "type": {"type": "STRING", "description": "Hesab�n t�r� (�rne�in 'Checking', 'Savings', 'CreditCard', 'Cash').  Sadece alabilece�i de�erler 'Checking', 'Savings', 'CreditCard', 'Cash', 'Investment', 'Loan', 'Other'."},
            "balance": {"type": "NUMBER", "description": "Hesab�n ba�lang�� bakiyesi."},
            "is_active": {"type": "BOOLEAN", "description": "Hesab�n aktif olup olmad���n� belirtir. Varsay�lan olarak True."},
            "currency": {"type": "STRING", "description": "Hesab�n para birimi (�rne�in 'TRY', 'USD', 'EUR'). Sadece alabilece�i de�erler 'TRY', 'USD', 'EUR', 'GBP', 'JPY', 'AUD', 'CAD', 'CHF'."}
        },
