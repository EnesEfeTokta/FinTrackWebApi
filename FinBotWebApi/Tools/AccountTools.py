...
CREATE_ACCOUNT_TOOL = {
    ...
    "parameters": {
        ...
        "properties": {
            ...
            "type": {"type": "STRING", "description": "Hesabın türü (örneğin 'Checking', 'Savings', 'CreditCard', 'Cash').  Sadece alabileceği değerler 'Checking', 'Savings', 'CreditCard', 'Cash', 'Investment', 'Loan', 'Other'."},
            "balance": {"type": "NUMBER", "description": "Hesabın başlangıç bakiyesi."},
            "is_active": {"type": "BOOLEAN", "description": "Hesabın aktif olup olmadığını belirtir. Varsayılan olarak True."},
            "currency": {"type": "STRING", "description": "Hesabın para birimi (örneğin 'TRY', 'USD', 'EUR'). Sadece alabileceği değerler 'TRY', 'USD', 'EUR', 'GBP', 'JPY', 'AUD', 'CAD', 'CHF'."}
        },
